            ...
            {events.map((event, i) => {
              ...
              return (
                ...
                >
                  {/* Timeline dot */}
                  <div
                    className={`absolute w-3 h-3 rounded-full border-2 ${borderClass} bg-background top-1 left-[1.5rem] -translate-x-1/2 ${
                      isLeft
                        ? "md:left-auto md:right-[-2rem] md:translate-x-1/2"
                        : "md:left-[-2rem]"
                    }`}
                    style={!isLeft ? { left: undefined } : undefined}
                  />
